...
export default class Disease_Type extends Component {
    callMe(){
...
// this is the onPress handler for the two buttons together
    ...
    language(){
        let fa={medicine:'درمان دارویی',plant_medicine:'درمان داروهای گیاهی',nonـmedical:'درمان های غیردارویی'};
        let en={medicine:'Medical treatment',plant_medicine:'Treating herbal remedies',nonـmedical:'Non-medical treatments'};
        let final = {};
        ...
        return (
            <View style={styles.container}>
                <TouchableHighlight
                    ...
                    onPress={()=>{
                        this.props.navigator.push({
                            screen: 'com.koalasolution.Medical_treatment',
                            title: this.language()['medicine'],
                            navigatorStyle: {navBarBackgroundColor:'#b2733a'}, // override the navigator style for the pushed screen (optional)
                ...
                <TouchableHighlight
                    ...
                    onPress={()=>{
                        this.props.navigator.push({
                            ...
                            title: this.language()['plant_medicine'],
                            passProps: ['plant_medicine'],
                            navigatorStyle: {navBarBackgroundColor:'#b2733a'}, // override the navigator style for the pushed screen (optional)

                        })}}>
                    <View style={styles.buttonIn}>
                        <Text style={styles.titles}>{this.language()['plant_medicine']}</Text>
                    </View>
                </TouchableHighlight>
                <TouchableHighlight
                    ...
                    onPress={()=>{
                        this.props.navigator.push({
                            screen: 'com.koalasolution.Non_medical_treatment',
                            title: this.language()['nonـmedical'],
                            navigatorStyle: {navBarBackgroundColor:'#b2733a'}, // override the navigator style for the pushed screen (optional)

                        });
                    }}>
                    <View style={styles.buttonIn}>
                        <Text style={styles.titles}>{this.language()['nonـmedical']}</Text>
                    </View>
                </TouchableHighlight>
                <View style={{height:0.1*height}}/>
                <Image source={require('./treatment.png')} style={{
                    alignItems: 'center',
                    width:0.5*width,
                    height:0.5*width,
