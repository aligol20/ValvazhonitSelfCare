...
export default class Non_medical_treatment extends Component {
    callMe(){
...
// this is the onPress handler for the two buttons together
    ...
    language(){
        let fa={probiotic:'طب مکمل و استفاده از ضدقارچ غیر طبیعی یا پروبیوتیک',Laser:'درمان با لیزر'};
        let en={probiotic:'Complementary Medicine and the use of abnormal antifungal or probiotic',Laser:'Laser therapy'};
        let final = {};
            ...
            <View style={styles.container}>
                <TouchableHighlight
                    ...
                    <View style={styles.buttonIn}>
                        <Text style={styles.titles}>{this.language()['probiotic']}</Text>
                ...
                <View
                    ...
                    >
                    <View style={styles.buttonIn}>
                        <Text style={styles.titles2}>{this.language()['Laser']}</Text>
                    </View>
                </View>

                <View style={{height:0.1*height}}/>
                <Image source={require('./herbal.png')} style={{
                    alignItems: 'center',
                    width:0.6*width,
                    height:0.6*width,
...
const styles = StyleSheet.create({
    ...
    buttonOut1:{width:0.8*width,borderRadius:7,marginTop: 7,flexDirection: 'row',borderWidth:2,borderColor:'#eb9040',backgroundColor: '#ffffff',justifyContent: 'center',alignItems: 'center'},
    buttonOut2:{width:0.8*width,borderRadius:7,marginTop: 7,flexDirection: 'row',borderWidth:2,borderColor:'#c67121',justifyContent: 'center',alignItems: 'center'},
    ...
    titles2:{
        fontFamily:'B Koodak',color: '#eb9040',textAlign:'center',marginTop: 13,marginBottom: 13,width:0.6*width
    }
});
module.export = Non_medical_treatment;
