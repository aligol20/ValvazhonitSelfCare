...
type Props = {};
export default class Reminder_deleted extends Component {
    constructor(props) {
            ...
            <View style={styles.container}>
                <View style={styles.container2}>
                    <LottieView
                        ...
                        loop={false}
                    />
                    <Text style={{margin: 7,fontFamily:'B Koodak',color: 'black',fontSize: 17}}>{'یادآورنده با موفقیت حذف گردید'}</Text>
...
module.export = Reminder_deleted;
