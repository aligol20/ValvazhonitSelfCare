...
export default class Patient_info extends Component {
    callMe(){
...
// this is the onPress handler for the two buttons together
    ...
    language(){
        let fa={clinical:'اطلاعات بالینی',demo:'اطلاعات دموگرافیک'};
        let en={clinical:'Demographic Information',demo:'Clinical Information'};
        let final = {};
        ...
        return (
            <View style={styles.container}>
                <TouchableHighlight
                    ...
                    onPress={()=>{
                        this.props.navigator.push({
                            screen: 'com.koalasolution.BaseInfo',
                            title: this.language()['demo'],
                            passProps: ['demo'],
                            navigatorStyle: {navBarBackgroundColor:'#c60c4b'}, // override the navigator style for the pushed screen (optional)

                        });
                    }}>
                    <View style={styles.buttonIn}>
                        <Text style={styles.titles}>{this.language()['demo']}</Text>
                ...
                <TouchableHighlight
                    ...
                    onPress={()=>{
                        this.props.navigator.push({
                            screen: 'com.koalasolution.ClinicalInfo',
                            title: this.language()['clinical'],
                            passProps: ['clinical'],
                            navigatorStyle: {navBarBackgroundColor:'#c60c4b'}, // override the navigator style for the pushed screen (optional)
                    ...
                    <View style={styles.buttonIn}>
                        <Text style={styles.titles}>{this.language()['clinical']}</Text>
                    </View>
                </TouchableHighlight>

                <View style={{height:0.1*height}}/>
                <Image source={require('./info.png')} style={{
                    alignItems: 'center',
                    width:0.5*width,
                    height:0.5*width,
