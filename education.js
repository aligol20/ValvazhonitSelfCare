...
import {Platform, StyleSheet,BackHandler, Text, Dimensions, Image, View, TouchableHighlight, AsyncStorage} from 'react-native';
...
// this is the onPress handler for the two buttons together
    ...
    language(){
        let fa={mainPoints:'موارد اصلی مربوط به بیماری ولوواژینیت کاندیدایی',sicknessTypes:'انواع درمان های بیماری ولوواژینیت کاندیدایی',lifeStyle:'مدیریت سبک زندگی'};
        let en={mainPoints:'The main cases of Candida vulvovaginal disease',sicknessTypes:'Types of Candida Vulvovaginal Disease Treatment',lifeStyle:'Lifestyle management'};
        let final = {};
            ...
            <View style={styles.container}>
                ...
                <TouchableHighlight
                    ...
                    <View style={styles.buttonIn}>
                        <Text style={styles.titles}>{this.language()['mainPoints']}</Text>
                ...
                <TouchableHighlight
                    ...
                    onPress={()=>{
                        this.props.navigator.push({
                            ...
                            title: this.language()['sicknessTypes'],
                            navigatorStyle: {navBarBackgroundColor:'#b2733a'}, // override the navigator style for the pushed screen (optional)

                        });
                    }}>
                    <View style={styles.buttonIn}>
                        <Text style={styles.titles}>{this.language()['sicknessTypes']}</Text>
                    </View>
                </TouchableHighlight>
                <TouchableHighlight
                    underlayColor="#eb9040"
                    ...
                    onPress={()=>{
                        this.props.navigator.push({
                            screen: 'com.koalasolution.Life_Style',
                            title: this.language()['lifeStyle'],
                            navigatorStyle: {navBarBackgroundColor:'#b2733a'}, // override the navigator style for the pushed screen (optional)

                        });
                    }}>
                    <View style={styles.buttonIn}>
                        <Text style={styles.titles}>{this.language()['lifeStyle']}</Text>
                    </View>
                </TouchableHighlight>
                <View style={{height:0.1*height}}/>
                <Image source={require('./apple.png')} style={{
                    alignItems: 'center',
                    width:0.78*width,
                    height:0.6*width,
