...
export default class Mazi extends Component {
    callMe(){
...
// this is the onPress handler for the two buttons together
    ...
    language(){
        let fa={hospitalList:'مراکز بیمارستان زنان و زایمان',drList:'لیست متخصصان زنان و زایمان',teh:'تهران بزرگ',sar:'استان مازندران',mazi:'مراکز تخصصی زنان و زایمان استان مازندران'};
        let en={hospitalList:'Obstetrics and Gynecology Hospitals',drList:'Gynecologists list',teh:'Capital Tehran',sar:'Mazandaran State',mazi:'Mazandaran Obstetrics and Gynecology Center'};
        let final = {};
    ...
    city(){
        let fa={tehran:'تهران',sari:'ساری',babol:'بابل',amol:'آمل',qaem:'قائمشهر',babolSar:'بابلسر',mahmood:'محمودآباد',freydoon:'فریدونکنار',noor:'نور',
            noShahr:'نوشهر',chaloos:'چالوس',tonekabon:'تنکابن',ramsar:'رامسر',behshahr:'بهشهر',neka:'نکا',jooybar:'جویبار',savadKooh:'سوادکوه',gloogah:'گلوگاه',kelar:'کلاردشت'};
        let en={tehran:'Tehran',sari:'sari',babol:'Babol',amol:'Amol',qaem:'QaemShahr',babolSar:'BabolSar',mahmood:'Mahmudabad',freydoon:'FreydunKenar',noor:'Noor',
            noShahr:'Noshahr',chaloos:'Chalus',tonekabon:'Tonekabon',ramsar:'Ramsar',behshahr:'BehShahr',neka:'Neka',jooybar:'Juybar',savadKooh:'SavadKuh',gloogah:'Galugah',kelar:'KelarDasht'};
        let final = {};
        console.log(this.state.language,';kfjgfj')
        switch(this.state.language) {
            case 'en':
    ...
    hospitals(){
        let fa= [
            {title:'بیمارستان صارم: (خصوصی) (تخصصی و فوق تخصصی) (شبانه‌روزی)',
                ...
                'دکتر ابوطالب طارمی، دکتر مژگان قرائی، دکتر آتوسا عزیزخانی، دکتر اقدس صفری، دکتر فرح اکبریان، دکتر فاطمه جلالی زند، دکتر طرلان حمیده‌خو، دکتر هما بهرامی، دکتر هما ایرانمنش، دکتر نوشین محمدی']},
        ...
        let en = [
            {title:'Sarem hospital: (private) (specialist) (boarding)'
                ...
                'Gynecologists:\n Dr. Abotaleb saremi-Dr. Mojhgan Gharaee- Dr. Atosa Azizkhani-Dr. Aghdas Safari- Dr. Farah Akbarian- Dr. Fatemeh Jalalizand – Dr. Tarlan Hamidehkho – Dr Homa bahrami- Dr. Homa Iranmanesh-Dr. Noshin mohammadi\n']},
            {title:'Khatam Hospital: (private) (specialist) (boarding)'
                ,data:['Address: Rashid Yasemi street, Above Mirdamad boulevard\n' +
                'Gynecologitists: Dr. Parvin Rohani- Dr. Roghyeh Mosazadeh\n' +
            ...
            ,{title:'Hazerat Zainab hospital: (Governmental) (boarding)'
            ...
            ,{title:'Moheb Yas hospital ( Formerly Mirza Khan): ( Governmental) (Curative education) (boarding)'
                ,data:['Adress: 6 Arwa, professor Nejatelahi street (villa)\n' +
                'Gynecologists:\n Dr. Firoozeh Akbari- Dr. Fariba Yarandi- Dr.Shirin Niromanesh- Dr. Zahra Rezaei – Dr. Ozra Azmodeh- Dr. Fatemeh Daveri Tanha- Dr. Azizeh Ghasemi Nejad- Dr. Nasrin Moghaddami Tabrizi – Dr. Mehrnaz- Boldan- Dr.Mahbod Ebrahimi']}
    ...
    sari(){
        ...
        let en= [
            ...
            {title:'Hekmat Hospital: (Tamin Ejtemaei) (Boarding)',
                ...
                'Gynecologists: \n' +
                'Dr. Fatemeh naije- Dr. Roya bayat- Dr.Hoda tabarestani- Dr. Fatemeh fazeltabar- Dr. Nahid Alishah- Dr. Maryam Asadi dizabadi- Dr. seyedeh roya mosayebi- Dr. seyedeh mojgan orand']},
    ...
    qaem(){
        let fa = [
            ...
            {title:'بیمارستان ولیعصر : (تأمین اجتماعی) (شبانه‌روزی)',
    ...
    chaloos(){
        ...
        let en = [
            ...
            {title:'Ayatollah taleghani Hospital: (Governmental) (Curative education) (Boarding)',
                ...
                'Gynecologists: \n' +
                'Dr.Vaskoei-Dr.hasantalab- Dr.Atabakhshi- Dr.Keshavarzian- Dr.Nejad shams- Dr.Talebi']},
    ...
    behshahr(){
        let fa = [
            ...
            {title:' بیمارستان دکتر امیدی: (خصوصی) (شبانه‌روزی)',
    ...
    gloogah(){
        ...
        let en = [
            ...
            {title:'Samenol-Aeme Hospital: (Governmental) (Curative education) (Boarding) \n',
        ...
        return (
            <ScrollView style={{flex: 1}}>
                ...
                <View style={styles.container}>
                    <Text style={styles.titles}>{this.language()['mazi']}</Text>
                        <View style={{flexDirection:'column',alignItems:'center',justifyContent:'center',width:width}}>
                            <Text style={styles.city}>{this.city()['sari']}</Text>
                        ...
                        />
                        <View style={{flexDirection:'column',alignItems:'center',justifyContent:'center',width:width}}>
                            <Text style={styles.city}>{this.city()['babol']}</Text>
                            <View style={styles.line}/>
                        </View>
                        <SectionList
                            style={{width:width}}
                        ...
                        />
                        <View style={{flexDirection:'column',alignItems:'center',justifyContent:'center',width:width}}>
                            <Text style={styles.city}>{this.city()['amol']}</Text>
                            <View style={styles.line}/>
                        </View>
                        <SectionList
                            style={{width:width}}
                        ...
                        />
                        <View style={{flexDirection:'column',alignItems:'center',justifyContent:'center',width:width}}>
                            <Text style={styles.city}>{this.city()['qaem']}</Text>
                            <View style={styles.line}/>
                        </View>
                        <SectionList
                            style={{width:width}}
                        ...
                        />
                        <View style={{flexDirection:'column',alignItems:'center',justifyContent:'center',width:width}}>
                            <Text style={styles.city}>{this.city()['babolSar']}</Text>
                            <View style={styles.line}/>
                        </View>
                        <SectionList
                            style={{width:width}}
                            ...
                            sections={this.babolSar()}
                            stickySectionHeadersEnabled = {false}
                            keyExtractor={(item, index) => item + index}
                        />
                        <View style={{flexDirection:'column',alignItems:'center',justifyContent:'center',width:width}}>
                            <Text style={styles.city}>{this.city()['mahmood']}</Text>
                            <View style={styles.line}/>
                        </View>
                        <SectionList
                            style={{width:width}}
                            ...
                            sections={this.mahmood()}
                            stickySectionHeadersEnabled = {false}
                            keyExtractor={(item, index) => item + index}
                        />
                        <View style={{flexDirection:'column',alignItems:'center',justifyContent:'center',width:width}}>
                            <Text style={styles.city}>{this.city()['freydoon']}</Text>
                            <View style={styles.line}/>
                        </View>
                        <SectionList
                            style={{width:width}}
                            ...
                            sections={this.freydoon()}
                            stickySectionHeadersEnabled = {false}
                            keyExtractor={(item, index) => item + index}
                        />
                        <View style={{flexDirection:'column',alignItems:'center',justifyContent:'center',width:width}}>
                            <Text style={styles.city}>{this.city()['noor']}</Text>
                            <View style={styles.line}/>
                        </View>
                        <SectionList
                            style={{width:width}}
                        ...
                        />
                        <View style={{flexDirection:'column',alignItems:'center',justifyContent:'center',width:width}}>
                            <Text style={styles.city}>{this.city()['noShahr']}</Text>
                            <View style={styles.line}/>
                        </View>
                        <SectionList
                            style={{width:width}}
                            ...
                            sections={this.noShahr()}
                            stickySectionHeadersEnabled = {false}
                            keyExtractor={(item, index) => item + index}
                        />
                        <View style={{flexDirection:'column',alignItems:'center',justifyContent:'center',width:width}}>
                            <Text style={styles.city}>{this.city()['chaloos']}</Text>
                            <View style={styles.line}/>
                        </View>
                        <SectionList
                            style={{width:width}}
                            ...
                            sections={this.chaloos()}
                            stickySectionHeadersEnabled = {false}
                            keyExtractor={(item, index) => item + index}
                        />
                        <View style={{flexDirection:'column',alignItems:'center',justifyContent:'center',width:width}}>
                            <Text style={styles.city}>{this.city()['tonekabon']}</Text>
                            <View style={styles.line}/>
                        </View>
                        <SectionList
                            style={{width:width}}
                            ...
                            sections={this.tonekabon()}
                            stickySectionHeadersEnabled = {false}
                            keyExtractor={(item, index) => item + index}
                        />
                        <View style={{flexDirection:'column',alignItems:'center',justifyContent:'center',width:width}}>
                            <Text style={styles.city}>{this.city()['ramsar']}</Text>
                            <View style={styles.line}/>
                        </View>
                        <SectionList
                            style={{width:width}}
                            ...
                            sections={this.ramsar()}
                            stickySectionHeadersEnabled = {false}
                            keyExtractor={(item, index) => item + index}
                        />
                        <View style={{flexDirection:'column',alignItems:'center',justifyContent:'center',width:width}}>
                            <Text style={styles.city}>{this.city()['behshahr']}</Text>
                            <View style={styles.line}/>
                        </View>
                        <SectionList
                            style={{width:width}}
                            ...
                            sections={this.behshahr()}
                            stickySectionHeadersEnabled = {false}
                            keyExtractor={(item, index) => item + index}
                        />
                        <View style={{flexDirection:'column',alignItems:'center',justifyContent:'center',width:width}}>
                            <Text style={styles.city}>{this.city()['neka']}</Text>
                            <View style={styles.line}/>
                        </View>
                        <SectionList
                            style={{width:width}}
                        ...
                        />
                        <View style={{flexDirection:'column',alignItems:'center',justifyContent:'center',width:width}}>
                            <Text style={styles.city}>{this.city()['jooybar']}</Text>
                            <View style={styles.line}/>
                        </View>
                        <SectionList
                            style={{width:width}}
                            ...
                            sections={this.jooybar()}
                            stickySectionHeadersEnabled = {false}
                            keyExtractor={(item, index) => item + index}
                        />
                        <View style={{flexDirection:'column',alignItems:'center',justifyContent:'center',width:width}}>
                            <Text style={styles.city}>{this.city()['savadKooh']}</Text>
                            <View style={styles.line}/>
                        </View>
                        <SectionList
                            style={{width:width}}
                            ...
                            sections={this.savadKooh()}
                            stickySectionHeadersEnabled = {false}
                            keyExtractor={(item, index) => item + index}
                        />
                        <View style={{flexDirection:'column',alignItems:'center',justifyContent:'center',width:width}}>
                            <Text style={styles.city}>{this.city()['gloogah']}</Text>
                            <View style={styles.line}/>
                        </View>
                        <SectionList
                            style={{width:width}}
                            ...
                            sections={this.gloogah()}
                            stickySectionHeadersEnabled = {false}
                            keyExtractor={(item, index) => item + index}
                        />
                        <View style={{flexDirection:'column',alignItems:'center',justifyContent:'center',width:width}}>
                            <Text style={styles.city}>{this.city()['kelar']}</Text>
                            <View style={styles.line}/>
                        </View>
                        <SectionList
                            style={{width:width}}
