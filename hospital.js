...
// this is the onPress handler for the two buttons together
    ...
    language(){
        let fa={tehran:'شاخص‌ترین مراکز تخحصصی زنان و زایمان تهران',mazi:'مراکز تخصصی زنان و زایمان استان مازندران'};
        let en={tehran:'The most specialized women’s gynecology centers in Tehran',mazi:'Mazandaran Obstetrics and Gynecology Center'};
        let final = {};
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                <TouchableHighlight
                    underlayColor="#cb245d"

                    style={styles.buttonOut}
                    onPress={()=>{
                        this.props.navigator.push({
                            screen: 'com.koalasolution.Notify',
                            title: this.language()['tehran'],
                            passProps: ['tehran'],
                            navigatorStyle: {navBarBackgroundColor:'#d6488c'}, // override the navigator style for the pushed screen (optional)

                        });
                    }}>
                    <View style={styles.buttonIn}>
                        <Text style={styles.titles}>{this.language()['tehran']}</Text>

                    </View>

                </TouchableHighlight>
                <TouchableHighlight
                    underlayColor="#d13c6e"

                    style={styles.buttonOut1}
                    onPress={()=>{
                        this.props.navigator.push({
                            screen: 'com.koalasolution.Mazi',
                            title: this.language()['mazi'],
                            passProps: ['mazi'],
                            navigatorStyle: {navBarBackgroundColor:'#d6488c'}, // override the navigator style for the pushed screen (optional)
                ...
                <Image source={require('./hospital.png')} style={{
                    alignItems: 'center',
                    width:0.5*width,
                    height:0.5*width,
...
const styles = StyleSheet.create({
    container: {
        ...
        justifyContent: 'center',
        alignItems: 'center',
        backgroundColor: '#f0dee6',
    },
    buttonIn:{borderRadius:7,flexDirection: 'row',justifyContent:'center',alignItems:'center'},
    buttonOut:{width:0.8*width,borderRadius:7,marginTop: 7,flexDirection: 'row',backgroundColor: '#c60c4b',justifyContent: 'center',alignItems: 'center'},
    buttonOut1:{width:0.8*width,borderRadius:7,marginTop: 7,flexDirection: 'row',backgroundColor: '#dc6d93',justifyContent: 'center',alignItems: 'center'},
